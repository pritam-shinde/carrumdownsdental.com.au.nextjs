                        ...
                        <Box mt={5} className={`${router.pathname !== "/service/wisdom-teeth-removal" ? Styles.fixedService : null} order-lg-1 order-0`}>
                            ...
                            <Box p={3} style={{ backgroundColor: "#11527826", borderRadius: "0 0 1rem 1rem" }}>
                                <Typography variant="h6" className="mt-3">
                                    <Link href="/service/wisdom-teeth-removal/">Wisdom Teeth Removal</Link>
                                </Typography>
                                <Typography variant="h6" className="mt-3">
                                    <Link href="/service/child-benefit/">Child Benefit</Link>
                                </Typography>
                                <Typography variant="h6" className="mt-3">
                                    <Link href="/service/dental-implants/">Dental Implants</Link>
                                </Typography>
                                <Typography variant="h6" className="mt-3">
                                    <Link href="/service/dentures/">Denture</Link>
                                </Typography>
                                <Typography variant="h6" className="mt-3">
                                    <Link href="/service/teeth-whitening/">Teeth Whitening</Link>
                                </Typography>
                                <Typography variant="h6" className="mt-3">
                                    <Link href="/service/crowns-and-bridge/">Crowns and Bridge</Link>
                                </Typography>
                                <Typography variant="h6" className="mt-3">
                                    <Link href="/service/veneers/">Veneers</Link>
                                </Typography>
                                <Typography variant="h6" className="mt-3">
                                    <Link href="/service/teeth-aligners/">Invisalign</Link>
                                </Typography>
                                <Typography variant="h6" className="mt-3">
                                    <Link href="/service/root-canal/">Root Canal</Link>
                                </Typography>
                                <Typography variant="h6" className="mt-3">
                                    <Link href="/service/teeth-cleaning/">Teeth Cleaning</Link>
                                </Typography>
                                <Typography variant="h6" className="mt-3">
                                    <Link href="/service/dental-emergency/">Dental Emergency</Link>
                                </Typography>
                                <Typography variant="h6" className="mt-3">
                                    <Link href="/service/tooth-fillings/">Tooth Fillings</Link>
                                </Typography>
                                <Typography variant="h6" className="mt-3">
                                    <Link href="/service/smile-design/">Smile Design</Link>
                                </Typography>
                                <Typography variant="h6" className="mt-3">
                                    <Link href="/service/digital-dentures/">Digital Dentures</Link>
                                </Typography>
                                <Typography variant="h6" className="mt-3">
                                    <Link href="/service/implant-supported-denture/">Implant Supported Denture</Link>
                                </Typography>
                                <Typography variant="h6" className="mt-3">
