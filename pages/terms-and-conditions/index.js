                                ...
                                <Box py={5}>
                                    ...
                                    <Box className='mt-4'>
                                        ...
                                        <Box>
                                            <List>
                                                {
                                                    ["This offer is only valid for dental appointments made and attended before the year-end (June 30, 2023).", "Offer does not include CT Scans and radiographs performed outside our facility", "Offer is inclusive of consultation and x-rays were done at our facility in preparation for this treatment", "The promotion package includes placement of a single implant crown, single titanium screw and single dental implant abutment for one tooth only.", "A prior examination will be performed on all patients to determine treatment suitability.A dental implant is not suitable for everyone.", "The patient will be required to pay for any additional dental treatments such as tooth extraction or bone grafting separately.", "The procedure is surgically invasive, which comes with several risks. It is important to seek a second opinion before proceeding with the treatment.", "Not to be used with other offers."].map(item => <ListItem key={item}>
                                                        <ListItemIcon>
                                                            <CheckCircleOutline style={{ color: 'var(--dark-blue)' }} />
                                                        </ListItemIcon>
                                                        <ListItemText primary={item} />
                                    ...
                                    <Box className="mt-4">
                                        ...
                                        <Box>
                                            <List>
                                                {
                                                    ["Please mention NEW-PATIENT-199-OFFER to avail this offer,", "This offer applies to New Patient dental appointments only and valid until June 2023", "The offer is only available on the condition of the availability of appointments with participating practitioners.", "Service is dependent on necessity. This service will only be given to patients who clinically need it.", "Independent practitioners will provide the dental services and procedures at our dental clinics.", "Xray or other Dental procedures are not included in this offer.", "Patients eligible for this offer are those who practice good oral hygiene, such as brushing twice a day, flossing, and regular dental checkups. If you require several sittings to get your teeth thoroughly cleaned, this offer will not be available for you.", "This offer cannot be redeemed or substituted for cash. In addition, it cannot be used together with other offers or Government schemes."].map(item => <ListItem><ListItemIcon>
                                                        <CheckCircleOutline style={{ color: 'var(--dark-blue)' }} />
                                                    </ListItemIcon>
                                                        <ListItemText primary={item} />
                                                    </ListItem>)
