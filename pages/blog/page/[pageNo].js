...
//   const Banner = useMemo(() => [Banner1, Banner2, Banner3, Banner4], []);
...
//                             <BlueFilledBtn btnLink="/blog/" btnTitle="FIRST" navlink={true} />
//                             {
//                               blogs?._paging && Number(pageNo) !== Number(blogs._paging.totalPages) && blogs._paging.links.next &&
//                               <BlueOulinedBtn btnLink={`/blog/page/${Number(pageNo) + 1}/`} btnTitle="NEXT" navlink={true} />
//                             }
//                             {
//                               pageNo !== '2' && blogs?._paging && blogs._paging.links.prev &&
//                               <BlueFilledBtn btnLink={`/blog/page/${Number(pageNo) - 1}/`} btnTitle="PREV" navlink={true} />
//                             }
//                             {
//                               blogs?._paging && Number(pageNo) !== Number(blogs._paging.totalPages) &&
//                               <BlueOulinedBtn btnLink={`/blog/page/${blogs._paging.totalPages}/`} btnTitle="LAST" navlink={true} />
//                             }
//                           </Box>
//                         </Grid>
//                         <Grid item xs={12} lg={4}>
