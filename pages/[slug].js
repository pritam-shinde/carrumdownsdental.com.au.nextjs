...
//     { id: "single_blog_breadcrumb_2", link: `/category/${filteredCat?.[0]?.slug || ''}/`, title: `${filteredCat?.[0]?.name || ''}` },
//     { id: "single_blog_breadcrumb_3", link: null, title: `${blog?.title?.rendered || ''}` }
//   ], [filteredCat, blog]);

//   const Banner = useMemo(() => [Banner1, Banner2, Banner4], []);

//   const renderBlogContent = useCallback(() => (
//     <>
//       <Box>
//         <img
...
//             </Head>
//           )}
//           <CommonHero breadcrumb={breadcrumb} bg={Banner[randomBanner]} title={blog?.title?.rendered || ''} color="#fff" />
//           <main>
//             <Container maxWidth="xxl">
//               <Grid container>
//                 <Grid item xs={12} md={10} className="mx-auto">
