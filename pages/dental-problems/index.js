                ...
                <Grid item xs={12} md={6}>
                  <Box sx={{ p: 2 }}>
                    ...
                    <Typography
                      ...
                      gutterBottom
                    >
                      At Carrum Downs Dental Group, we provide excellent dental
                      care through quality services. Our skilled dentists and
                      staff would love to inform you about common dental issues
                      and ensure you know how to avoid them.
                    </Typography>
                    <Typography
                      variant="body1"
                      className="text-white"
                      gutterBottom
                    >
                      Oral health issues are remarkably common, but many people
                      don't know how to properly address them. Ignoring dental
                      problems can lead to severe consequences later on. Regular
                      dental exams are crucial for catching problems early
                      before they worsen. The key is being proactive with dental
                      care rather than waiting until you have a crisis
                      situation. With consistent preventative care and good oral
                      hygiene habits, your teeth and gums can stay in excellent
                      shape.
                    </Typography>
                    <Box>
                      <BlueFilledBtn
              ...
              <Grid container spacing={2}>
                ...
                <Grid item xs={12} md={6}>
                  <Box sx={{ p: 1 }}>
                    ...
                    <Typography variant="body1" gutterBottom>
                      With decades of experience handling common dental issues,
