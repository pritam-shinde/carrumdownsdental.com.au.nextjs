...
import { BookAndCall, CommonHero, CommonSidebar, SectionalHeading, CustomCard, InterestFree, TermsNCondition, BlueFilledBtn, BlueOulinedBtn, IconBtn, VeneerData, VeneerProcessData, BeforeAfterData } from '../../../components/components';
import { Grid, Typography, Button, Paper, Container, Box, List, ListItem, ListItemIcon, ListItemText, Card, CardMedia, CardContent } from '@mui/material';
...
import Veneer from '../../../public/Veneers/bg-carrum.webp';
import BgSectionImg from "../../../public/Veneers/veneer-bg-image.webp";
import pageImage2 from "../../../public/Veneers/group.webp";
    ...
    <>
      ...
      {show && (
        <main>
              ...
              <Grid container spacing={2} py={2}>
                ...
                <Grid item xs={12} md={6} >
                  <Box style={{ maxWidth: '800px', margin: 'auto', overflow: 'hidden' }}>
                    <ReactCompareSlider style={{ maxWidth: '800px', height: 'auto' }}
          ...
          <section className='teeth-missing-section1' style={{
            marginBottom: "2rem", position: 'relative', backgroundImage: `url(${BgSectionImg.src})`,
            ...
            <Container>
              ...
              <Typography className="para mt-2">
                Achieve a radiant, lasting smile with our comprehensive veneer process. We prioritise meticulous care and precision throughout the seven steps, ensuring a comfortable experience and natural-looking
                results that perfectly complement your unique smile.
              </Typography>
              <Grid container spacing={2}>
