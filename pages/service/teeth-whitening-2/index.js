                                                    ...
                                                    <Grid container spacing={3}>
                                                        <Grid item xs={12} sm={6}>
                                                            <Card className='tWCard shadow'>
                                                                ...
                                                                <CardContent>
                                                                    <Typography variant='h5' color="var(--dark-blue)">Zoom Chair Whitening</Typography>
                                                                    <List>
                                                                        <ListItem>
                                                                            <ListItemIcon>
                                        ...
                                        <section className='mt-md-5 mt-4'>
                                            <Container maxWidth="xxl">
                                                <Box className='border'>
                                                    <Grid container>
                                                        <Grid item xs={6} className="border"><Box onClick={() => setSelectedTab('zoom')} component={Button} py={2} className={`tab ${selectedTab == "zoom" ? 'bg--blue' : 'bg-light'}`} fullWidth><Typography variant='h6' align='center'>Zoom Teeth Whitening</Typography></Box></Grid>
                                                        ...
                                                        <Grid item xs={12}>
                                                            {
                                                                selectedTab == 'zoom' ? <>
                                                                    <Box p={3}>
                                                                        <Box>
                                                                            <SectionalHeading variant="h3" title="Zoom Teeth Whitening" align='left' color="var(--dark-blue)" />
                                                                            ...
                                                                            <Box mt={2}>
                                                                                <SectionalHeading variant="h4" title="How does it work" align='left' color="var(--dark-blue)" />
                                                                            ...
                                                                            <Box mt={2}>
                                                                                <SectionalHeading variant="h4" title="What to Expect During the Procedure?" align='left' color="var(--dark-blue)" />
                                                                            ...
                                                                            <Box mt={2}>
                                                                                <SectionalHeading variant="h4" title="Contact Carrum Downs Dental Group for Zoom Whitening " align='left' color="var(--dark-blue)" />
                                                                    ...
                                                                    <Box p={3}>
                                                                        <Box>
                                                                            <SectionalHeading variant="h3" title="Boutique Teeth Whitening" align='left' color="var(--dark-blue)" />
                                                                        ...
                                                                        <Box>
                                                                            <SectionalHeading variant="h4" title="Boutique by Day and Boutique by Night" align='left' color="var(--dark-blue)" />
                                                                            <Typography className='para'>These two procedures are designed to fit different tastes and preferences. </Typography>
                                                                        </Box>
                                                                        <Box>
                                                                            <SectionalHeading variant="h5" title="Boutique Whitening by Day" align='left' color="var(--dark-blue)" />
                                                                        ...
                                                                        <Box>
                                                                            <SectionalHeading variant="h5" title="Boutique by Night" align='left' color="var(--dark-blue)" />
                                                                        ...
                                                                        <Box>
                                                                            <SectionalHeading variant="h5" title="Choosing Boutique by Day or Boutique by Night" align='left' color="var(--dark-blue)" />
                                                                        ...
                                                                        <Box>
                                                                            <SectionalHeading variant="h5" title="Why Choose Professional Boutique Teeth Whitening over at home Whitening Kit" align='left' color="var(--dark-blue)" />
