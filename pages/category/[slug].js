...
// export const getServerSideProps = async (context) => {
//   const { slug } = context.params;
//   const response = await fetch(`https://apicarrumdownsdental.myconcept.website/wp-json/wp/v2/categories?slug=${slug}`);
//   const category = await response.json();

//   const allBlogsRes = await fetch('https://apicarrumdownsdental.myconcept.website/wp-json/wp/v2/posts?_embed=true&per_page=5&page=1');
//   const allBlogs = await allBlogsRes.json();

//   const categoriesRes = await fetch('https://apicarrumdownsdental.myconcept.website/wp-json/wp/v2/categories?_embed=true&per_page=99');
...
//   const Banner = useMemo(() => [Banner1, Banner3, Banner4], []);
