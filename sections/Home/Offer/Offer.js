                    ...
                    <Grid item xs={12} md={10} className="mx-auto">
                        ...
                        <Box py={3}>
                            <Grid container spacing={3}>
                                {
                                    [
                                        { id: "Home_offer_Sec_Offer1", image: Offer1, title: "*New Patient 199 Offer - Scale & Clean with Full Check-up", para: null, list: ["Comprehensive Dental Examination", "Scale & Clean", "Fluoride"], price: "$199*", small: "or 4 equal payments of $49.75*" },
